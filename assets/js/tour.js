(function(ava) {
ava.Tour = {}
ava.Tour.view = function() {
	return m("div", { class: "body" }, [
		...
		m("div", { class: "container" }, [
			...
			m("div", { class: "row" }, [
				m("div", { class: "col-md-1 margin-top-sm" }, [
					m("img", {
						src: "/public/images/icon_burger.svg",
						class: "tour-icon"
					})
				]),
				m("div", { class: "col-md-11 margin-top-sm" }, [
					m("h4", "Eat well"),
			...
			m("div", { class: "row margin-top-sm" }, [
				m("p", {
					style: "font-style:italic"
				}, "And so much more...")
			]),
			m("div", { class: "row margin-top-sm text-center" }, [
				m("h2", [
					"Text Ava at ",
					m("span", {
						class: "color-primary"
